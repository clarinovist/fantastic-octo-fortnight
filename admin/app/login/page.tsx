          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl p-8 max-w-lg shadow-2xl">
            ...
            <blockquote className="space-y-6">
              <p className="text-2xl font-medium leading-relaxed text-white">
                &quot;This platform has revolutionized how we manage our private
                tutoring sessions. The admin tools are simply intuitive and have
              ...
              <footer className="flex items-center gap-4 border-t border-white/20 pt-6">
                <div className="h-12 w-12 overflow-hidden rounded-full border-2 border-white/40 shadow-sm bg-zinc-200">
                  {/* Placeholder Avatar if image fails / no image provided */}
                  <Image
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDhukFtXTqOLSnYQWofBoT9_UJnrj4xHCgueu6TfsNi51zGduqjELS9uHw79A0wGtqgCcJs5L10Am_XG7g0UQRQUy7-pp8XMUMuSU-8rewppoEpl0jIEs4MfjrEjVP33CjK2oQxTA7rJ7LnVV54LUdmTDwsFEITLu8PVPRQv-KffXUVJ6WMlBD5vO4Iekl50-5LBo8-Ybk-MfANq4bL8x0fEqQOYOj5-PQEB8le1ZVWo9dlc1fTa_QhVpuLvvkJCGOhpvD3mKZPYGMO"
                    alt="Sofia Davis"
