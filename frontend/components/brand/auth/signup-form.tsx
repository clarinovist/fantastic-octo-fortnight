...
const UserIcon = (props: IconProps) => {
  return (
    ...
    >
      <path
        d="M8.99935 0C7.89428 0 6.83447 0.421427 6.05307 1.17157C5.27167 1.92172 4.83268 2.93913 4.83268 4C4.83268 5.06087 5.27167 6.07828 6.05307 6.82843C6.83447 7.57857 7.89428 8 8.99935 8C10.1044 8 11.1642 7.57857 11.9456 6.82843C12.727 6.07828 13.166 5.06087 13.166 4C13.166 2.93913 12.727 1.92172 11.9456 1.17157C11.1642 0.421427 10.1044 0 8.99935 0ZM14.2077 10H3.79102C2.96221 10 2.16736 10.3161 1.58131 10.8787C0.995256 11.4413 0.666016 12.2044 0.666016 13C0.666016 15.232 1.62227 17.02 3.19102 18.23C4.73477 19.42 6.8056 20 8.99935 20C11.1931 20 13.2639 19.42 14.8077 18.23C16.3743 17.02 17.3327 15.232 17.3327 13C17.3327 12.2044 17.0034 11.4413 16.4174 10.8787C15.8313 10.3161 15.0365 10 14.2077 10Z"
        fill={props.fill}
      />
    </svg>
  )
...
const PhoneIcon = (props: IconProps) => {
  return (
    ...
    >
      <path
        d="M10.0417 0C12.7056 0.00131783 15.2059 1.03023 17.086 2.89791C18.9662 4.7655 20.001 7.24829 20 9.88814C19.9978 15.2819 15.6191 19.6802 10.2063 19.7677L10.042 19.769H10.0378C8.3968 19.7684 6.78391 19.3664 5.34633 18.6027L5.27914 18.5666L0 19.9405L1.41273 14.82C0.541406 13.3219 0.0828906 11.6219 0.0835938 9.88023C0.0857813 4.4324 4.55305 0 10.0417 0ZM10.0452 1.66899C5.47977 1.66899 1.76672 5.35295 1.76492 9.88109C1.7643 11.4091 2.18867 12.8982 2.99297 14.1921L3.03031 14.2517L3.22719 14.5625L2.39102 17.5929L5.52359 16.7777L5.82586 16.9555C7.07641 17.6919 8.50711 18.0872 9.96781 18.1L10.0385 18.1003H10.042C14.6038 18.1003 18.3168 14.4161 18.3187 9.88767C18.3195 7.69326 17.4595 5.62977 15.8967 4.07744C14.334 2.52512 12.2559 1.66969 10.0452 1.66891M6.51625 5.31721C6.68203 5.31721 6.84828 5.31876 6.99312 5.32612C7.14594 5.33357 7.35102 5.26853 7.55289 5.74984C7.63039 5.93434 7.7482 6.21938 7.86883 6.51054L7.89469 6.57295C8.08883 7.04155 8.28289 7.50876 8.32023 7.58295C8.38234 7.70643 8.42375 7.85078 8.34086 8.01543C8.25805 8.18031 8.21641 8.28318 8.09211 8.42752C7.96766 8.57155 7.83086 8.74946 7.71891 8.86L7.70062 8.87806L7.6825 8.89643C7.57156 9.01031 7.47875 9.14085 7.60984 9.36364C7.75492 9.61093 8.25422 10.4196 8.99391 11.0742C9.9443 11.9153 10.7461 12.176 10.9949 12.2997C11.2437 12.4233 11.3889 12.4026 11.534 12.2377C11.6792 12.073 12.1559 11.5169 12.3219 11.2697C12.4877 11.0226 12.6536 11.0639 12.8817 11.1462C12.9901 11.1853 13.3234 11.3409 13.6702 11.5066L13.778 11.5582C14.1251 11.7249 14.4636 11.8906 14.5819 11.9494C14.8307 12.073 14.9966 12.1348 15.0588 12.2377C15.1209 12.3408 15.1209 12.835 14.9136 13.4117C14.7063 13.9885 13.7122 14.5148 13.2341 14.5858C12.8055 14.6492 12.263 14.6757 11.667 14.488C11.3057 14.374 10.8421 14.2222 10.2484 13.9678C7.7525 12.8985 6.12227 10.4046 5.99797 10.2399L5.98953 10.2288C5.83789 10.0277 4.98187 8.87643 4.98187 7.68581C4.98187 6.4707 5.62477 5.87341 5.85273 5.6262C6.08086 5.37922 6.35039 5.31721 6.51625 5.31721Z"
        fill={props.fill}
      />
    </svg>
  )
...
const signupSchema = z
  .object({
    fullName: z
      ...
      .max(15, {
        message: "Nama lengkap maksimal 15 karakter",
      }),
...
export function SignupForm() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      const result = await signIn("google", {
        callbackUrl: `${window.location.origin}/auth/callback?state=signup`,
        redirect: false,
      })
      ...
      if (result?.error) {
        ...
        window.location.href = result.url + "&state=signup"
      }
    } catch (error) {
  ...
  const classNameInput = (isError: boolean) => {
    return `focus-visible:border-main focus-visible:ring-0 border-2 pl-12 pr-4 py-6 text-lg rounded-full placeholder:text-main-300 ${
      isError
  ...
  return (
    <Card className="w-full p-4 mx-4 bg-white border-0 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.15)] rounded-3xl">
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="h-[136px] lg:h-full lg:min-h-[400px] relative w-full rounded-[24px] overflow-hidden">
          <Image
        ...
        <div className="space-y-6 flex-1 md:px-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      ...
                      <div className="relative">
                        <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
                          <div className="w-12 h-12 flex items-center justify-center">
                            <UserIcon fill={errors.fullName ? "#FF0004" : "#7000FE"} />
                          </div>
                        </div>
                        <Input
                          type="text"
                          ...
                          {...field}
                          className={classNameInput(!!errors.fullName)}
                        />
                      </div>
                    </FormControl>
                  </FormItem>
                  ...
                  <FormItem>
                    <FormControl>
                      <div className="relative">
                        <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
                          <div className="w-12 h-12 flex items-center justify-center">
                            <Mail fill={errors.email ? "#FF0004" : "#7000FE"} />
                          </div>
                        </div>
                        <Input
                          type="email"
                  ...
                  <FormItem>
                    <FormControl>
                      <PhoneInput
                        ...
                        className={classNameInput(!!errors.phoneNumber)}
                        value={field.value}
                        onChange={field.onChange}
                        error={!!errors.phoneNumber}
                        icon={<PhoneIcon fill={errors.phoneNumber ? "#FF0004" : "#7000FE"} />}
                      />
                    </FormControl>
                  </FormItem>
                )}
                    ...
                    <FormControl>
                      <RadioGroup {...field} onValueChange={field.onChange} className="flex gap-4">
                        ...
                        <FormItem className="flex-1">
                          <div className="relative">
                            <FormLabel htmlFor="tutor" className="cursor-pointer block">
                              <div
                        ...
                        <FormItem className="flex-1">
                          <div className="relative">
                            <FormLabel htmlFor="student" className="cursor-pointer block">
                              <div
                                className={`
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          {...field}
                          className={classNameInput(!!errors.password)}
                        />
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input
                          ...
                          {...field}
                          className={classNameInput(!!errors.confirmPassword)}
                        />

                        <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10">
                          <div
                            className={`w-12 h-12 rounded-full flex items-center justify-center ${errors.confirmPassword ? "bg-red-500" : "bg-main"}`}
                          >
                            <KeyIcon />
                          </div>
                        </div>
              ...
              {/* Signup Button and Google Sign In */}
